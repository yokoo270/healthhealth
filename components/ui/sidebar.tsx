  ...
  (
    ...
    return (
      ...
      >
        ...
        <div
          className={cn(
            "duration-200 relative h-[80vh] w-[--sidebar-width] bg-transparent transition-[width] ease-linear",
        ...
        <div
          className={cn(
            "duration-200 fixed top-[10vh] z-10 hidden h-[80vh] w-[--sidebar-width] transition-[left,right,width] ease-linear md:flex",
            side === "left"
