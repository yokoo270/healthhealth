  ...
  (
    ...
    return (
      ...
      >
        ...
        <div
          className={cn(
            "duration-200 relative h-[85vh] w-[--sidebar-width] bg-transparent transition-[width] ease-linear",
        ...
        <div
          className={cn(
            "duration-200 fixed top-[7.5vh] z-10 hidden h-[85vh] w-[--sidebar-width] transition-[left,right,width] ease-linear md:flex",
            side === "left"
